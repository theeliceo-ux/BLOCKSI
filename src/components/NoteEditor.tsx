            ...
            <div className="flex-1 flex flex-col relative min-h-[220px]">
              {isPreview ? (
                ...
                <textarea
                  ...
                  className="w-full flex-grow bg-transparent text-black placeholder-black/35 resize-none focus:outline-none text-sm md:text-base leading-relaxed p-2 font-mono"
